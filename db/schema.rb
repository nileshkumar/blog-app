...
ActiveRecord::Schema.define(version: 2021_05_08_115617) do
  ...
  create_table "comments_reactions", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "comment_id"
